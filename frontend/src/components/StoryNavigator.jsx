...
const StoryNavigator = ({ isLoaded }) => {
  ...
  const chapters = [
    ...
    { id: 'philosophy', title: 'Philosophy', num: '03' },
    { id: 'philosophy-snapshots', title: 'Snapshots', num: '04' },
    { id: 'pillars', title: 'Programs', num: '05' },
    { id: 'journey', title: 'Core Values', num: '06' },
    { id: 'gallery', title: 'Archive', num: '07' },
  ...
  return (
    <div className="story-navigator-container fixed right-6 md:right-8 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col items-end gap-6 select-none opacity-0">
      {/* Decorative vertical track line */}
      <div className="absolute right-[11px] top-4 bottom-4 w-px bg-brand-dark/10 pointer-events-none">
        <div 
